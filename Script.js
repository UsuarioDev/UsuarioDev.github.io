const API_URL = `https://api.thecatapi.com/v1/images/search?limit=5&api_key=live_phtzSSQ1X0i8hJWkcFh2lY7BQ1I3LsBZAdvdNV2qGIs0Tc8cTqpVcXUxio4RiYLk`;
const API_KEY = "live_phtzSSQ1X0i8hJWkcFh2lY7BQ1I3LsBZAdvdNV2qGIs0Tc8cTqpVcXUxio4RiYLk";
...
function showImageToVoteOn()
{
  ...
  .then((data) => {
    ...
    console.log(currentImageToVoteOn.url)
  });
